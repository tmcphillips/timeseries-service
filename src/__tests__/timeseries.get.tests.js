...
describe("When a values GET request selects first pixel of first band in 5x5x5 data cube", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?datasetId=5x5x5&variableName=temp&lng=-123.0&lat=45.0&start=0&end=0'
		});
    });
...
describe("When a values GET request selects last pixel of each band in 5x5x5 data cube", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?datasetId=5x5x5&variableName=temp&lng=-119.0&lat=49.0&start=0&end=4'
		});
    });
...
describe("When a values GET request selects last pixel of last band in 5x5x5 data cube", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?datasetId=5x5x5&variableName=temp&lng=-119.0&lat=49.0&start=4&end=4'
		});
    });
...
describe("When a values GET request selects last pixel of 5x5x5 data cube without specifying the bands", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?datasetId=5x5x5&variableName=temp&lng=-119.0&lat=49.0'
		});
    });
...
describe("When a values GET request selects last pixel of 5x5x5 data cube and specifies start but not end band", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?datasetId=5x5x5&variableName=temp&lng=-119.0&lat=49.0&start=2'
		});
    });
...
describe("When a values GET request selects last pixel of 5x5x5 data cube and specifies end but not start band", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?datasetId=5x5x5&variableName=temp&lng=-119.0&lat=49.0&end=3'
		});
    });
