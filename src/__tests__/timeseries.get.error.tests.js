...
describe("When a values GET request specifies coordinates outside of raster file", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?dataset=5x5x5&variable=temp&lng=-124.0&lat=45.0&start=0&end=4'
		});
    });
...
describe("When a values GET request specifies a dataset that does not exist", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?dataset=not-a-dataset&variable=temp&lng=-123.0&lat=45.0&start=0&end=4'
		});
    });
...
describe("When a values GET request specifies a nonexistent variable for dataset", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?dataset=5x5x5&variable=not-a-variable&lng=-123.0&lat=45.0&start=0&end=4'
		});
    });
...
describe("When a values GET request specifies a range start outside of dataset coverage", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?dataset=5x5x5&variable=temp&lng=-123.0&lat=45.0&start=5&end=5'
		});
    });
...
describe("When a values GET request specifies a range end outside of dataset coverage", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?dataset=5x5x5&variable=temp&lng=-123.0&lat=45.0&start=3&end=5'
		});
    });
...
describe("When a values GET request specifies a range end before range start", async () => {
	...
	beforeAll(async () => {
		response = await callRESTService({
		    method: 'GET',
		    path: timeseriesServiceBase + '/values?dataset=5x5x5&variable=temp&lng=-123.0&lat=45.0&start=4&end=3'
		});
    });
